...
<table class="portfolio-table"><thead><tr><th>Symbol</th><th>Asset type</th><th class="numeric">Quantity</th></tr></thead><tbody>@for(p of positions();track p.instrumentId){<tr><td><strong>{{p.symbol}}</strong></td><td>{{p.instrumentType}}</td><td class="numeric">{{p.quantity|number:'1.0-8'}}</td></tr>}@empty{<tr><td colspan="3" class="empty">No positions currently held.</td></tr>}</tbody></table></section>
