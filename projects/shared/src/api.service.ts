...
import { Account,CashBalance,Instrument,Order,OrderEvent,Position,Quote,ReportSummary } from './models';
...
export class ApiService {
 ...
 reportSummary(){return this.http.get<ReportSummary>(`${this.base}/admin/reports/summary`);} reportActivity(){return this.http.get<Record<string,unknown>[]>(`${this.base}/admin/reports/activity`);} reportInstruments(){return this.http.get<Record<string,unknown>[]>(`${this.base}/admin/reports/instruments`);} reportSegments(){return this.http.get<Record<string,unknown>[]>(`${this.base}/admin/reports/client-segments`);} reportVolume(){return this.http.get<Record<string,unknown>[]>(`${this.base}/admin/reports/volume`);}
}
